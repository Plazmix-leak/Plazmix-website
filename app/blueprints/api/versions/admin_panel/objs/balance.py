...
from app.core.user.module import UserAuthSession, UserBalanceLog
from app.core.permissions import Permissions


class Balance(IApiClass, ABC):
    ...
    def get(self, request: ApiRequest, query, user_session: UserAuthSession):
        ...
        logs: List[UserBalanceLog] = UserBalanceLog.get_from_user(target, 150)
